public class account_balance_check extends javax.swing.JFrame {

    public account_balance_check() {
        initComponents();
        jTextField1.setText(Double.toString(ATM_Operations.accountBalance));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(account_balance_check.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new account_balance_check().setVisible(true);
            }
        });
    }                   */
